...
/**
 * If a variable reference x cannot be traced back to an enclosing let-definition or
 * function parameter, this is an error. [The variable x will be undefined and
